...
const REGIONS: { name: string; description: string; top: string; left: string }[] = [
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:px-8">
        <div className="relative aspect-[3/4] w-full max-w-md overflow-hidden rounded-3xl bg-paper-100 shadow-rideflow-editorial-card">
          <svg
          ...
          {REGIONS.map((region) => (
            ...
            >
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border-2 border-forest-800 bg-paper-50">
                <span className="h-1.5 w-1.5 rounded-full bg-forest-800" />
              </span>
              <span className="rounded-md bg-paper-50/95 px-2 py-0.5 text-[11px] font-semibold text-ink-950 shadow-sm">
                {region.name}
              </span>
            </div>
          ))}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="mt-2 grid gap-3 sm:grid-cols-2">
            <article className="flex items-center gap-3 rounded-2xl bg-paper-100 p-4 ring-1 ring-paper-200">
              <span
                aria-hidden="true"
              ...
              <div className="flex flex-col">
                ...
                <span className="mt-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-forest-800">
                  220 km
                </span>
              </div>
            </article>
